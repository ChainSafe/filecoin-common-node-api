...
impl super::Ctx {
    pub fn Filecoin_AuthNew(
        ...
        self.call("Filecoin.AuthNew", (params,))
    }
    pub fn Filecoin_AuthVerify(
        &mut self,
        header_raw: &str,
    ) -> Result<Option<Vec<String>>, TestFailure> {
        self.call("Filecoin.AuthVerify", (header_raw,))
    }
    pub fn Filecoin_BeaconGetEntry(&mut self, first: i64) -> Result<BeaconEntry, TestFailure> {
        self.call("Filecoin.BeaconGetEntry", (first,))
    }
    ...
    pub fn Filecoin_ChainGetParentReceipts(
        &mut self,
        block_cid: &Cid,
    ) -> Result<Option<Vec<ApiReceipt>>, TestFailure> {
        self.call("Filecoin.ChainGetParentReceipts", (block_cid,))
    }
    pub fn Filecoin_ChainGetMessagesInTipset(
        &mut self,
        tsk: Option<&Vec<Cid>>,
    ) -> Result<Option<Vec<ApiMessage>>, TestFailure> {
        self.call("Filecoin.ChainGetMessagesInTipset", (tsk,))
    }
    pub fn Filecoin_ChainExport(
        &mut self,
        params: &ChainExportParams,
    ) -> Result<Option<String>, TestFailure> {
        self.call("Filecoin.ChainExport", (params,))
    }
    ...
    pub fn Filecoin_ChainStatObj(
        &mut self,
        obj_cid: &Cid,
        base_cid: Option<&Cid>,
    ) -> Result<ObjStat, TestFailure> {
        self.call("Filecoin.ChainStatObj", (obj_cid, base_cid))
    }
    pub fn Filecoin_ChainGetBlockMessages(
        &mut self,
        cid: &Cid,
    ) -> Result<BlockMessages, TestFailure> {
    ...
    pub fn Filecoin_ChainGetGenesis(&mut self) -> Result<Option<Tipset>, TestFailure> {
        self.call("Filecoin.ChainGetGenesis", ())
    }
    ...
    pub fn Filecoin_ChainSetHead(&mut self, tsk: Option<&Vec<Cid>>) -> Result<(), TestFailure> {
        self.call("Filecoin.ChainSetHead", (tsk,))
    }
    pub fn Filecoin_ChainGetMinBaseFee(&mut self, lookback: u32) -> Result<String, TestFailure> {
        self.call("Filecoin.ChainGetMinBaseFee", (lookback,))
    }
    ...
    pub fn Filecoin_Session(&mut self) -> Result<uuid::Uuid, TestFailure> {
        self.call("Filecoin.Session", ())
    }
    pub fn Filecoin_Version(&mut self) -> Result<PublicVersion, TestFailure> {
        self.call("Filecoin.Version", ())
    }
    pub fn Filecoin_Shutdown(&mut self) -> Result<(), TestFailure> {
        self.call("Filecoin.Shutdown", ())
    }
    pub fn Filecoin_StartTime(
        &mut self,
    ) -> Result<chrono::DateTime<chrono::offset::Utc>, TestFailure> {
        self.call("Filecoin.StartTime", ())
    }
    ...
    pub fn Filecoin_MpoolPushUntrusted(&mut self, msg: &SignedMessage) -> Result<Cid, TestFailure> {
    ...
    pub fn Filecoin_MsigGetAvailableBalance(
        &mut self,
        address: &Address,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<BigInt, TestFailure> {
        self.call("Filecoin.MsigGetAvailableBalance", (address, tipset_key))
    }
    pub fn Filecoin_MsigGetPending(
        &mut self,
        address: &Address,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<Option<Vec<Transaction>>, TestFailure> {
        self.call("Filecoin.MsigGetPending", (address, tipset_key))
    }
    pub fn Filecoin_MsigGetVested(
        &mut self,
        address: &Address,
        start_tsk: Option<&Vec<Cid>>,
        end_tsk: Option<&Vec<Cid>>,
    ) -> Result<BigInt, TestFailure> {
        self.call("Filecoin.MsigGetVested", (address, start_tsk, end_tsk))
    }
    pub fn Filecoin_MsigGetVestingSchedule(
        &mut self,
        address: &Address,
        tsk: Option<&Vec<Cid>>,
    ) -> Result<MsigVesting, TestFailure> {
        self.call("Filecoin.MsigGetVestingSchedule", (address, tsk))
    }
    ...
    pub fn Forest_NetInfo(&mut self) -> Result<NetInfoResult, TestFailure> {
        self.call("Forest.NetInfo", ())
    }
    ...
    pub fn Filecoin_NetAutoNatStatus(&mut self) -> Result<NatStatusResult, TestFailure> {
        self.call("Filecoin.NetAutoNatStatus", ())
    }
    pub fn Filecoin_NetProtectAdd(&mut self, acl: &str) -> Result<(), TestFailure> {
        self.call("Filecoin.NetProtectAdd", (acl,))
    }
    pub fn Filecoin_NetFindPeer(&mut self, peer_id: &str) -> Result<AddrInfo, TestFailure> {
        self.call("Filecoin.NetFindPeer", (peer_id,))
    }
    pub fn Filecoin_NodeStatus(&mut self) -> Result<NodeStatusResult, TestFailure> {
        self.call("Filecoin.NodeStatus", ())
    }
    ...
    pub fn Filecoin_StateListMessages(
        ...
        tipset_key: Option<&Vec<Cid>>,
        max_height: i64,
    ) -> Result<Option<Vec<Cid>>, TestFailure> {
        self.call(
    ...
    pub fn Filecoin_StateNetworkName(&mut self) -> Result<String, TestFailure> {
        self.call("Filecoin.StateNetworkName", ())
    }
    ...
    pub fn Filecoin_StateSectorGetInfo(
        ...
        sector_number: u64,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<Option<SectorOnChainInfo>, TestFailure> {
        self.call(
            "Filecoin.StateSectorGetInfo",
            (miner_address, sector_number, tipset_key),
        )
    }
    pub fn Filecoin_StateSectorPreCommitInfoV0(
        &mut self,
        miner_address: &Address,
        sector_number: u64,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<SectorPreCommitOnChainInfo, TestFailure> {
        self.call(
    ...
    pub fn Filecoin_StateMinerPartitions(
        ...
        deadline_index: u64,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<Option<Vec<MinerPartitions>>, TestFailure> {
        self.call(
    ...
    pub fn Filecoin_StateGetReceipt(
        &mut self,
        cid: &Cid,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<Receipt, TestFailure> {
        self.call("Filecoin.StateGetReceipt", (cid, tipset_key))
    }
    ...
    pub fn Filecoin_StateNetworkVersion(
        &mut self,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<u32, TestFailure> {
        self.call("Filecoin.StateNetworkVersion", (tipset_key,))
    }
    ...
    pub fn Filecoin_StateDealProviderCollateralBounds(
        ...
        verified: bool,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<DealCollateralBounds, TestFailure> {
        self.call(
    ...
    pub fn Filecoin_StateWaitMsgV0(
        &mut self,
        message_cid: &Cid,
        confidence: i64,
    ) -> Result<MessageLookup, TestFailure> {
        self.call("Filecoin.StateWaitMsgV0", (message_cid, confidence))
    }
    ...
    pub fn Filecoin_StateSearchMsgLimited(
        &mut self,
        message_cid: &Cid,
        look_back_limit: i64,
    ) -> Result<MessageLookup, TestFailure> {
        self.call(
            ...
            (message_cid, look_back_limit),
        )
    }
    pub fn Forest_StateFetchRoot(
        &mut self,
        root_cid: &Cid,
        save_to_file: Option<&str>,
    ) -> Result<String, TestFailure> {
        self.call("Forest.StateFetchRoot", (root_cid, save_to_file))
    }
    pub fn Forest_StateCompute(&mut self, epoch: i64) -> Result<Cid, TestFailure> {
        self.call("Forest.StateCompute", (epoch,))
    }
    ...
    pub fn Filecoin_StateVerifiedRegistryRootKey(
        &mut self,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<Address, TestFailure> {
    ...
    pub fn Filecoin_StateGetAllClaims(
        &mut self,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<std::collections::HashMap<String, ClaimLotusJson>, TestFailure> {
    ...
    pub fn Filecoin_StateGetAllAllocations(
        &mut self,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<std::collections::HashMap<String, Allocation>, TestFailure> {
    ...
    pub fn Filecoin_StateSectorExpiration(
        ...
        sector_number: u64,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<SectorExpiration, TestFailure> {
        self.call(
    ...
    pub fn Filecoin_StateSectorPartition(
        ...
        sector_number: u64,
        tipset_key: Option<&Vec<Cid>>,
    ) -> Result<SectorLocation, TestFailure> {
        self.call(
            "Filecoin.StateSectorPartition",
            (miner_address, sector_number, tipset_key),
        )
    }
    pub fn Filecoin_SyncCheckBad(&mut self, cid: &Cid) -> Result<String, TestFailure> {
        self.call("Filecoin.SyncCheckBad", (cid,))
    }
    pub fn Filecoin_SyncMarkBad(&mut self, cid: &Cid) -> Result<(), TestFailure> {
        self.call("Filecoin.SyncMarkBad", (cid,))
    }
    pub fn Filecoin_SyncState(&mut self) -> Result<RpcSyncState, TestFailure> {
        self.call("Filecoin.SyncState", ())
    }
    pub fn Filecoin_SyncSubmitBlock(&mut self, blk: &GossipBlock) -> Result<(), TestFailure> {
        self.call("Filecoin.SyncSubmitBlock", (blk,))
    }
    pub fn Filecoin_WalletBalance(&mut self, address: &Address) -> Result<BigInt, TestFailure> {
        self.call("Filecoin.WalletBalance", (address,))
    }
    pub fn Filecoin_WalletDefaultAddress(&mut self) -> Result<Option<Address>, TestFailure> {
        self.call("Filecoin.WalletDefaultAddress", ())
    }
    pub fn Filecoin_WalletExport(&mut self, address: &Address) -> Result<KeyInfo, TestFailure> {
        self.call("Filecoin.WalletExport", (address,))
    }
    pub fn Filecoin_WalletHas(&mut self, address: &Address) -> Result<bool, TestFailure> {
        self.call("Filecoin.WalletHas", (address,))
    }
    pub fn Filecoin_WalletImport(&mut self, key: &KeyInfo) -> Result<Address, TestFailure> {
        self.call("Filecoin.WalletImport", (key,))
    }
    pub fn Filecoin_WalletList(&mut self) -> Result<Option<Vec<Address>>, TestFailure> {
        self.call("Filecoin.WalletList", ())
    }
    pub fn Filecoin_WalletNew(
        &mut self,
        signature_type: &SignatureTypeLotusJson,
    ) -> Result<Address, TestFailure> {
        self.call("Filecoin.WalletNew", (signature_type,))
    }
    pub fn Filecoin_WalletSetDefault(&mut self, address: &Address) -> Result<(), TestFailure> {
        self.call("Filecoin.WalletSetDefault", (address,))
    }
    pub fn Filecoin_WalletSign(
        &mut self,
        address: &Address,
        message: &Base64String,
    ) -> Result<Signature, TestFailure> {
        self.call("Filecoin.WalletSign", (address, message))
    }
    pub fn Filecoin_WalletSignMessage(
        &mut self,
        address: &Address,
        message: &Message,
    ) -> Result<SignedMessage, TestFailure> {
    ...
    pub fn Filecoin_WalletValidateAddress(
        &mut self,
        address: &str,
    ) -> Result<Address, TestFailure> {
        self.call("Filecoin.WalletValidateAddress", (address,))
    }
    pub fn Filecoin_WalletVerify(
        &mut self,
        address: &Address,
        message: &Base64String,
        signature: &Signature,
    ) -> Result<bool, TestFailure> {
        self.call("Filecoin.WalletVerify", (address, message, signature))
    }
    pub fn Filecoin_WalletDelete(&mut self, address: &Address) -> Result<(), TestFailure> {
        self.call("Filecoin.WalletDelete", (address,))
    }
}
#[doc = r" Error types."]
pub mod error {
...
impl From<&AuthNewParams> for AuthNewParams {
...
pub struct ChainExportParams {
    ...
    pub tipset_keys: NullableArrayOfCid,
}
impl From<&ChainExportParams> for ChainExportParams {
    fn from(value: &ChainExportParams) -> Self {
        value.clone()
    }
}
#[doc = "Cid"]
...
impl From<&GossipBlock> for GossipBlock {
...
pub struct KeyInfo {
    ...
    pub private_key: Base64String,
    #[serde(rename = "Type")]
    pub type_: SignatureTypeLotusJson,
}
impl From<&KeyInfo> for KeyInfo {
...
impl From<&MsigVesting> for MsigVesting {
    fn from(value: &MsigVesting) -> Self {
        value.clone()
    }
}
#[doc = "NatStatusResult"]
...
impl From<&NatStatusResult> for NatStatusResult {
    fn from(value: &NatStatusResult) -> Self {
        value.clone()
    }
}
#[doc = "NetInfoResult"]
...
#[doc = "    \"num_peers\","]
#[doc = "    \"num_pending\","]
#[doc = "    \"num_pending_incoming\","]
#[doc = "    \"num_pending_outgoing\""]
#[doc = "  ],"]
#[doc = "  \"properties\": {"]
#[doc = "    \"num_connections\": {"]
#[doc = "      \"type\": \"integer\","]
...
impl From<&NetInfoResult> for NetInfoResult {
    fn from(value: &NetInfoResult) -> Self {
        value.clone()
    }
}
#[doc = "NetworkParams"]
...
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"blocks_per_tipset_last_100\","]
#[doc = "    \"blocks_per_tipset_last_finality\""]
#[doc = "  ],"]
#[doc = "  \"properties\": {"]
#[doc = "    \"blocks_per_tipset_last_100\": {"]
#[doc = "      \"type\": \"number\","]
...
impl From<&NodeChainStatus> for NodeChainStatus {
    fn from(value: &NodeChainStatus) -> Self {
        value.clone()
    }
}
#[doc = "NodePeerStatus"]
...
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"peers_to_publish_blocks\","]
#[doc = "    \"peers_to_publish_msgs\""]
#[doc = "  ],"]
#[doc = "  \"properties\": {"]
#[doc = "    \"peers_to_publish_blocks\": {"]
#[doc = "      \"type\": \"integer\","]
...
impl From<&NodePeerStatus> for NodePeerStatus {
    fn from(value: &NodePeerStatus) -> Self {
        value.clone()
    }
}
#[doc = "NodeStatusResult"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
...
#[doc = "  \"properties\": {"]
#[doc = "    \"chain_status\": {"]
#[doc = "      \"$ref\": \"#/definitions/NodeChainStatus\""]
#[doc = "    },"]
#[doc = "    \"peer_status\": {"]
#[doc = "      \"$ref\": \"#/definitions/NodePeerStatus\""]
#[doc = "    },"]
#[doc = "    \"sync_status\": {"]
#[doc = "      \"$ref\": \"#/definitions/NodeSyncStatus\""]
#[doc = "    }"]
#[doc = "  }"]
#[doc = "}"]
#[doc = r" ```"]
...
impl From<&NodeStatusResult> for NodeStatusResult {
    fn from(value: &NodeStatusResult) -> Self {
        value.clone()
    }
}
#[doc = "NodeSyncStatus"]
...
impl From<&NodeSyncStatus> for NodeSyncStatus {
    fn from(value: &NodeSyncStatus) -> Self {
        value.clone()
    }
}
...
#[doc = "  ],"]
#[doc = "  \"items\": {"]
#[doc = "    \"$ref\": \"#/definitions/SyncState\""]
#[doc = "  }"]
#[doc = "}"]
#[doc = r" ```"]
#[doc = r" </details>"]
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct NullableArrayOfSyncState(pub Option<Vec<SyncState>>);
impl std::ops::Deref for NullableArrayOfSyncState {
    type Target = Option<Vec<SyncState>>;
    fn deref(&self) -> &Option<Vec<SyncState>> {
        &self.0
    }
}
impl From<NullableArrayOfSyncState> for Option<Vec<SyncState>> {
    fn from(value: NullableArrayOfSyncState) -> Self {
        value.0
    }
}
impl From<&NullableArrayOfSyncState> for NullableArrayOfSyncState {
    fn from(value: &NullableArrayOfSyncState) -> Self {
        value.clone()
    }
}
impl From<Option<Vec<SyncState>>> for NullableArrayOfSyncState {
    fn from(value: Option<Vec<SyncState>>) -> Self {
        Self(value)
    }
}
...
#[doc = r" </details>"]
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct NullableDateTime(pub Option<chrono::DateTime<chrono::offset::Utc>>);
impl std::ops::Deref for NullableDateTime {
    type Target = Option<chrono::DateTime<chrono::offset::Utc>>;
    fn deref(&self) -> &Option<chrono::DateTime<chrono::offset::Utc>> {
        &self.0
    }
}
impl From<NullableDateTime> for Option<chrono::DateTime<chrono::offset::Utc>> {
    fn from(value: NullableDateTime) -> Self {
        value.0
    }
}
impl From<&NullableDateTime> for NullableDateTime {
    fn from(value: &NullableDateTime) -> Self {
        value.clone()
    }
}
impl From<Option<chrono::DateTime<chrono::offset::Utc>>> for NullableDateTime {
...
#[doc = r" </details>"]
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct NullableTipset(pub Option<Tipset>);
impl std::ops::Deref for NullableTipset {
    type Target = Option<Tipset>;
    fn deref(&self) -> &Option<Tipset> {
        &self.0
    }
}
impl From<NullableTipset> for Option<Tipset> {
    fn from(value: NullableTipset) -> Self {
        value.0
    }
}
impl From<&NullableTipset> for NullableTipset {
    fn from(value: &NullableTipset) -> Self {
        value.clone()
    }
}
impl From<Option<Tipset>> for NullableTipset {
    fn from(value: Option<Tipset>) -> Self {
        Self(value)
    }
}
#[doc = "ObjStat"]
...
impl From<&ObjStat> for ObjStat {
    fn from(value: &ObjStat) -> Self {
        value.clone()
    }
}
...
#[doc = "Represents the current version of the API."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"Represents the current version of the API.\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"APIVersion\","]
#[doc = "    \"BlockDelay\","]
...
#[doc = "  \"properties\": {"]
#[doc = "    \"APIVersion\": {"]
#[doc = "      \"$ref\": \"#/definitions/ShiftingVersion\""]
#[doc = "    },"]
#[doc = "    \"BlockDelay\": {"]
#[doc = "      \"type\": \"integer\","]
#[doc = "      \"format\": \"uint32\","]
...
impl From<&PublicVersion> for PublicVersion {
...
#[doc = "  \"properties\": {"]
#[doc = "    \"ActiveSyncs\": {"]
#[doc = "      \"$ref\": \"#/definitions/Nullable_Array_of_SyncState\""]
#[doc = "    }"]
#[doc = "  }"]
#[doc = "}"]
#[doc = r" ```"]
...
pub struct RpcSyncState {
    ...
    pub active_syncs: NullableArrayOfSyncState,
}
impl From<&RpcSyncState> for RpcSyncState {
    fn from(value: &RpcSyncState) -> Self {
        value.clone()
    }
}
...
#[doc = "Integer based value on version information. Highest order bits for Major, Mid order for Minor and lowest for Patch."]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"description\": \"Integer based value on version information. Highest order bits for Major, Mid order for Minor and lowest for Patch.\","]
#[doc = "  \"type\": \"integer\","]
#[doc = "  \"format\": \"uint32\","]
#[doc = "  \"minimum\": 0.0"]
#[doc = "}"]
...
#[doc = r" </details>"]
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct ShiftingVersion(pub u32);
impl std::ops::Deref for ShiftingVersion {
    type Target = u32;
    fn deref(&self) -> &u32 {
        &self.0
    }
}
impl From<ShiftingVersion> for u32 {
    fn from(value: ShiftingVersion) -> Self {
        value.0
    }
}
impl From<&ShiftingVersion> for ShiftingVersion {
    fn from(value: &ShiftingVersion) -> Self {
        value.clone()
    }
}
impl From<u32> for ShiftingVersion {
    fn from(value: u32) -> Self {
        Self(value)
    }
}
impl std::str::FromStr for ShiftingVersion {
    type Err = <u32 as std::str::FromStr>::Err;
    fn from_str(value: &str) -> Result<Self, Self::Err> {
        Ok(Self(value.parse()?))
    }
}
impl std::convert::TryFrom<&str> for ShiftingVersion {
    type Error = <u32 as std::str::FromStr>::Err;
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        value.parse()
    }
}
impl std::convert::TryFrom<&String> for ShiftingVersion {
    type Error = <u32 as std::str::FromStr>::Err;
    fn try_from(value: &String) -> Result<Self, Self::Error> {
        value.parse()
    }
...
impl ToString for ShiftingVersion {
    fn to_string(&self) -> String {
        self.0.to_string()
    }
}
...
#[doc = r" </details>"]
#[derive(Clone, Debug, Deserialize, Eq, Hash, Ord, PartialEq, PartialOrd, Serialize)]
pub struct SyncStage(pub String);
impl std::ops::Deref for SyncStage {
    type Target = String;
    fn deref(&self) -> &String {
        &self.0
    }
}
impl From<SyncStage> for String {
    fn from(value: SyncStage) -> Self {
        value.0
    }
}
impl From<&SyncStage> for SyncStage {
    fn from(value: &SyncStage) -> Self {
        value.clone()
    }
}
impl From<String> for SyncStage {
    fn from(value: String) -> Self {
        Self(value)
    }
}
...
#[doc = "  \"properties\": {"]
#[doc = "    \"Base\": {"]
#[doc = "      \"$ref\": \"#/definitions/Nullable_Tipset\""]
#[doc = "    },"]
#[doc = "    \"End\": {"]
#[doc = "      \"$ref\": \"#/definitions/Nullable_DateTime\""]
#[doc = "    },"]
#[doc = "    \"Epoch\": {"]
#[doc = "      \"type\": \"integer\","]
#[doc = "      \"format\": \"int64\""]
...
pub struct SyncState {
    ...
    pub base: Option<NullableTipset>,
    #[serde(rename = "End", default, skip_serializing_if = "Option::is_none")]
    pub end: Option<NullableDateTime>,
    #[serde(rename = "Epoch")]
    pub epoch: i64,
    #[serde(rename = "Message")]
    pub message: String,
    ...
    pub start: Option<NullableDateTime>,
    #[serde(rename = "Target", default, skip_serializing_if = "Option::is_none")]
    pub target: Option<NullableTipset>,
}
impl From<&SyncState> for SyncState {
...
pub struct Transaction {
    ...
    pub approved: NullableArrayOfAddress,
    #[serde(rename = "ID")]
    pub id: i64,
    #[serde(rename = "Method")]
    pub method: u64,
